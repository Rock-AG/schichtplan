 ...
 * Localize flatpickr
 */
var German = __webpack_require__(/*! flatpickr/dist/l10n/de.js */ "./node_modules/flatpickr/dist/l10n/de.js");
...
function addEvents() {
  ...
  if (el !== null) {
    el.addEventListener("change", function () {
      var e1 = new Date(document.getElementById('start').value);
      var e2 = new Date(e1);
...
function deleteWithConfirm() {
  var forms = document.querySelectorAll('form.delete-with-confirm');
  if (forms.length > 0) {
    forms.forEach(function (form) {
      var msg = form.dataset['confirmDeleteMsg'];
...
function createAccordion() {
  ...
  new (accordion_js__WEBPACK_IMPORTED_MODULE_1___default())(accordions);
}
document.addEventListener('DOMContentLoaded', createAccordion);
function registerCopyLink() {
  var copyButtons = Array.from(document.querySelectorAll(".js-copy-link"));
  copyButtons.forEach(function (e) {
    e.addEventListener('click', function () {
      var _this = this;
      var textField = document.getElementById(this.dataset.inputId);
      textField.select();
      textField.setSelectionRange(0, 9999);
      navigator.clipboard.writeText(textField.value).then(function () {
        _this.querySelector('span').textContent = _this.dataset.successText;
        textField.blur();
      })["catch"](function (err) {
